				...
				__awaiter(this, void 0, void 0, function* () {
					...
					if (item.tehnicalEquipment) {
						...
						const technicalEquipment =
							new TechnicalEquipment_1.TehnicalEquipment(
					...
					if (item.officeEquipment) {
						...
						const officeEquipment = new OfficeEquipment_1.OfficeEquipment(
							equipment.description,
							record
						);
