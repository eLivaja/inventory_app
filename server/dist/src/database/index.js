...
class DB {
    ...
    connect(connect = true) {
        return __awaiter(this, void 0, void 0, function* () {
            __classPrivateFieldSet(this, _DB_instance, yield core_1.MikroORM.init(Object.assign(Object.assign({}, __classPrivateFieldGet(this, _DB_config, "f")), { populateAfterFlush: true, entitiesTs: entities_1.default, metadataProvider: reflection_1.TsMorphMetadataProvider }), connect), "f");
            return __classPrivateFieldGet(this, _DB_instance, "f");
        });
    }
}
